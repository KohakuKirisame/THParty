		...
		<div class="col-sm-12 col-lg-6 my-sm-3">
			<div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white">
				...
				<div class="list-group list-group-flush border-bottom scrollarea" id="groupList">
					<div class="list-group-item py-3 lh-tight groupItem d-flex" id="groupItem1" score="3">
		...
		<div class="row">
			...
			<div class="col-sm-12 col-lg-6 my-sm-3">
				<div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white">
					...
					<div class="list-group list-group-flush border-bottom scrollarea" id="groupList">
						<div class="list-group-item py-3 lh-tight groupItem" id="groupItem1" score="3">
							<div class="row d-flex">
								<div class="col-6 d-flex"><input type="text" class="groupName form-control input-large input align-items-center" id="groupName1" placeholder="队伍名称..." tid="1"></div>
								<div class="groupCount col-5">
									<div class="row">
										<div class="col-8">
											<div class="row">
												<div class="col-4 p-0">
													<img src="./assets/img/full.png" tid="1" imgN="1" width="100%">
												</div>
												<div class="col-4 p-0">
													<img src="./assets/img/full.png" tid="1" imgN="2" width="100%">
												</div>
												<div class="col-4 p-0">
													<img src="./assets/img/full.png" tid="1" imgN="3" width="100%">
												</div>
											</div>
										</div>
										<div class="col-4 d-flex align-items-center">
