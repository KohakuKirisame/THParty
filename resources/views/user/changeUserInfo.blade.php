		...
		<div class="card-body">
			<form method="POST" action="/Actions/ChangeUserInfo" id="infoForm">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-9 col-lg-10">
						<input type="text" class="form-control" id="sign" name="sign" value="{{$user->sign}}">
					</div>
				</div>
				<div class="mb-3 row">
					<label for="intro" class="col-sm-3 col-lg-2 col-form-label">自我介绍</label>
					<div class="col-sm-9 col-lg-10">
						<textarea form="infoForm" type="text" class="form-control" id="introduction" name="introduction">{!! $user->introduction !!}</textarea>
					</div>
				</div>
