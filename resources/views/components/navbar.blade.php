<div class="main-wrapper">
	<nav class="sidebar">
		...
		<div class="sidebar-body">
			<ul class="nav">
				<li class="nav-item nav-category"><b>聚会</b></li>
				<li class="nav-item">
					<a class="nav-link" data-bs-toggle="collapse" href="#parties" role="button" aria-expanded="false" aria-controls="parties">
						<i class="link-icon" data-feather="mail"></i>
						<span class="link-title">我的聚会</span>
				...
				<li class="nav-item">
					<a href="#games" class="nav-link">
						...
						<span class="link-title">我的游戏</span>
					</a>
					<div class="collapse" id="games">
						<ul class="nav sub-menu">
							<li class="nav-item">
								<a href="pages/email/inbox.html" class="nav-link">To be continued.</a>
							</li>
				...
				<li class="nav-item">
					...
					<div class="collapse" id="general-pages">
						<ul class="nav sub-menu">
							...
							<li class="nav-item">
								<a href="pages/general/faq.html" class="nav-link">修改手机</a>
							</li>
						</ul>
					</div>
				</li>
				<li class="nav-item">
					...
					<div class="collapse" id="authPages">
						<ul class="nav sub-menu">
							<li class="nav-item">
								<a href="pages/auth/login.html" class="nav-link">修改资料</a>
							</li>
				...
				<li class="nav-item">
					<a href="http://www.bootstrapmb.com/html/documentation/docs.html" target="_blank" class="nav-link">
						<i class="link-icon" data-feather="hash"></i>
						<span class="link-title">退出登录</span>
					</a>
				</li>
			</ul>
		</div>
